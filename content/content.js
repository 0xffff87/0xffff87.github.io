...
(function () {
  ...
  function clientRuleMatch(fieldsMeta, resumeData) {
    ...
    var rules = [
      { label_re: /^(?:姓名|真实姓名|请输入真实姓名|请输入姓名|请输入.*姓名|名字)$/, name_re: /^(?:name|fullName|realname|姓名)$/i,
      ...
      { label_re: /(?:意向.*城市|意愿.*城市|意向.*地点|目标.*城市|期望.*城市|期望.*地点)/, name_re: /^(?:preferred_city_list|targetCity|expectCity)$/i,
      ...
      { label_re: /^(?:工作职位|岗位名称|职位名称|请输入.*职位)$/, name_re: /^(?:positionName\d*|jobTitle|work|title|职位名称)$/i,
      ...
      { label_re: /^(?:项目名称|请输入.*项目名称)$/, name_re: /^(?:subjectName\d*|projectName|项目名称)$/i,
      ...
      { label_re: /(?:意向.*职位|目标.*职位|期望.*职位|期望.*岗位|目标.*岗位|求职.*岗位)/, name_re: /^(?:targetJob|targetPosition|expectPosition|expectJob)$/i,
        parent_kw: ['意向职位', '目标职位', '期望职位', '求职岗位'], value: basic.targetPosition, unique: true, key: 'targetPosition' },
      ...
      { label_re: /(?:专业技能|技能特长|技术技能|请.*技能)/, name_re: /^(?:skills|技能)$/i,
        parent_kw: ['专业技能', '技能特长', '技能'], value: resumeData.skills || basic.skills, unique: true, key: 'skills', skip_date: true },
